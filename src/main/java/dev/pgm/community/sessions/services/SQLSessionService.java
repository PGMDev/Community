...
public class SQLSessionService extends SQLFeatureBase<Session, SessionQuery> {
  ...
  private static final String TABLE_FIELDS =
      "(id VARCHAR(36) PRIMARY KEY, player VARCHAR(36), disguised BOOL, server VARCHAR(32), start_time LONG, end_time LONG)";
  ...
  private class UpdateSessionEndTimeQuery implements Query {
    ...
    private static final String FORMAT = "UPDATE " + TABLE_NAME + " SET end_time = ? WHERE id = ?";
