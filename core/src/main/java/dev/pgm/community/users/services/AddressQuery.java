...
public interface AddressQuery {
  ...
  static final String LATEST_IP_TABLE_FIELDS = String.format(
  ...
  static final String INSERT_LATEST_IP_QUERY = "REPLACE INTO "
  ...
  static final String INSERT_IP_QUERY = "INSERT INTO "
      + IP_TABLE_NAME
      + " ("
      + IP_ADDRESS_FIELD
      + ","
  ...
  static final String INSERT_IP_USER_QUERY = "INSERT INTO "
      + IP_USER_TABLE_NAME
      + " ("
      + USER_ID_FIELD
      + ","
