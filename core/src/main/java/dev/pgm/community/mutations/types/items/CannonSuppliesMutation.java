...
public class CannonSuppliesMutation extends KitMutationBase {
  ...
  static List<Kit> spawnKit = Lists.newArrayList(new ItemKit(
      ...
      preventSharing(Lists.newArrayList(
          ...
          new ItemStack(Material.WATER_BUCKET),
          new ItemStack(CommunityMaterials.FENCE, 32),
          new ItemStack(CommunityMaterials.WOOD_STEP, 64),
          new ItemStack(Material.TNT, 64),
          new ItemStack(CommunityMaterials.WOOD, 64),
          new ItemStack(Material.TNT, 64),
          new ItemStack(CommunityMaterials.DIODE, 64)))));
