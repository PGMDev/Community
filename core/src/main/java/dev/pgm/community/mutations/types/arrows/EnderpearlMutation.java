...
public class EnderpearlMutation extends MutationBase implements BowMutation {

  private ModifyBowProjectileMatchModule module;

  public EnderpearlMutation(Match match) {
    super(match, MutationType.ENDERPEARL);
  }
  ...
  public void enable() {
    super.enable();
    this.module = new ModifyBowProjectileMatchModule(
        match, EnderPearl.class, 1, Sets.newHashSet(), StaticFilter.ALLOW);
    module.enable();
