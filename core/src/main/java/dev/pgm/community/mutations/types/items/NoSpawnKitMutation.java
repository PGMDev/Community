...
public class NoSpawnKitMutation extends MutationBase {
  ...
  private static final MutationBooleanOption CLEAR_ITEMS_OPTION = new MutationBooleanOption(
      "Clear Items", "Whether items should be removed", Material.STICK, true, false);

  private static final MutationBooleanOption CLEAR_ARMOR_OPTION = new MutationBooleanOption(
      "Clear Armor", "Whether armor should be removed", Material.CHAINMAIL_HELMET, true, false);

  private static final MutationBooleanOption CLEAR_EFFECTS_OPTION = new MutationBooleanOption(
