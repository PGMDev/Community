...
import static dev.pgm.community.platform.CommunityEvents.EVENTS;
...
public class GrapplingHookMutation extends KitMutationBase {
  ...
  public void onPlayerFishEvent(PlayerFishEvent event) {
    ...
    Location hookLocation = EVENTS.getFishHook(event).getLocation();
    ...
    Audience.get(event.getPlayer()).playSound(Sounds.BAT_TAKEOFF);
