...
public enum MutationType {
  ...
  EXPLOSION("Explosion", "TNT, Fireballs, and random explosions", CommunityMaterials.GUN_POWDER),
  ...
  HEALTH("Health", "Double health", CommunityMaterials.RED_ROSE),
  ...
  MOBS("Mob", "Attack of the mobs", CommunityMaterials.MOB_SPAWNER),
  TNT_BOW("TNT Bow", "All projectiles are TNT", Material.TNT),
  FIREBALL_BOW("Fireball Bow", "All projectiles are fireballs", CommunityMaterials.FIREBALL),
